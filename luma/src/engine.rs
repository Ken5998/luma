...
///
/// Luma relies on a small handful of optional wgpu features for its fast paths
...
impl Luma {
    ...
    pub fn new(
        ...
        {
            return Err("Luma requires nonzero logical and backing dimensions".into());
        }
        log::info!("✨ Initialising Luma");
